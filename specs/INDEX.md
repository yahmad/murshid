...
| T15 | TUI spike (gitui-inspired; replaces the watch pane) — branch `yasir/mur-7-tui-spike` only | Spike complete (2026-07-05; gated PASS; 620+1 tests, clippy clean) — awaiting founder hands-on eval + merge decision | [T15-tui-spike.md](tasks/T15-tui-spike.md) |
