...
| T15 | TUI spike (gitui-inspired; replaces the watch pane) — branch `yasir/mur-7-tui-spike` only | Active — spike, founder-directed 2026-07-05 (MUR-7) | [T15-tui-spike.md](tasks/T15-tui-spike.md) |

**Active spec for current work:** T15 — TUI spike (branch `yasir/mur-7-tui-spike`; NOT for main without a separate merge decision)
