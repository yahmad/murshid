//! Minimal, dependency-free SHA-256 (FIPS 180-4) implementation.
//!
//! Used for C2 session-start content snapshots and for site/advice-fingerprint
//! hashing. Standard-library only, per repo convention.
...
/// Computes the SHA-256 digest of `data` and returns it as a 32-byte array.
