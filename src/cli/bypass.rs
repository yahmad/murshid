pub fn check_bypass_limits(conn: &rusqlite::Connection, _max_sessions: u32) -> rusqlite::Result<u32> {
...
pub fn run_bypass(
    ...
    log_bypass_session(conn, duration_seconds, reason_code, workspace_hash, files_count)
